...
| Visualization | Cameras → surrounding model; other vehicles, brake/turn lamps, lane color when Autosteer/FSD active, proximity rays | partial — blue lane, block buildings, car-shaped traffic with lamps. Simulated, not camera perception |
