...
| --- | --- | --- | --- | --- |
| Parked home | `screenshots/parked-home.png` | `manual-m3-touchscreen-p8.jpg`, `nata-parked-car-vis.jpg` | PARTIAL | 2026-09-22: cool close fog + overhead key on the light studio, light dock, folder All Apps glyph. Candy Ultra Red, C-pillar streak, pane glass, oval shadow, TRUNK card. Mesh ceiling remains (front well, side glass). Not Tesla’s Unreal park scene. |
...
| FSD engaged | `screenshots/fsd-engaged.png` | `nata-ui-v12-hero.jpg`, `nata-intel-spring-update.jpg` (`manual-m3-driving-status-p16.jpg` is Car Status p.14, not a driving viz) | PARTIAL | 2026-09-22: closer chase cam, overcast gray world, dark asphalt, blue lane, windowed blocks, car-shaped traffic with amber turn lamps. ~128px speed + hairline power bar; limit sign and blue set-speed over the road. Media strip spans the viz. Map driven path stays gray. Not an occupancy mesh. |
...
| Viz expanded | `screenshots/viz-expanded.png` | `nata-park-assist-fullscreen.jpg` | PARTIAL | 2026-09-22: mini-map stays a map. Navigate card + media strip sit on the viz with the closer chase view, windowed blocks, amber lamps, and the large speed cluster. Density is still lighter than the park-assist still. |
