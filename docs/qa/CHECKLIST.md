...
| --- | --- | --- | --- | --- |
| Parked home | `screenshots/parked-home.png` | `manual-m3-touchscreen-p8.jpg`, `nata-parked-car-vis.jpg`, `nata-status-bar.jpg` | PARTIAL | 2026-09-25 Highland import. Proportions PASS vs nata. Ultra Red, dark glass, and source wheels are in frame. Paint, glass, wheels, lighting, and leaders stay PARTIAL. Status order unchanged. See `MESH_REVIEW.md`. |
...
| Parked full-screen vehicle | UI v12 notes + `nata-parked-car-vis.jpg` | PARTIAL | Scene `parked-home` loads the Studio Highland mesh in Ultra Red. Silhouette, lamps, glass, and wheels are the Highland asset. Leader layout is still PARTIAL. See `LICENSE-3D.md` + `MESH_REVIEW.md`. |
