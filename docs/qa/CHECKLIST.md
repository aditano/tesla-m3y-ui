...
| FSD engaged | `screenshots/fsd-engaged.png` | `nata-ui-v12-hero.jpg`, `nata-intel-spring-update.jpg` (`manual-m3-driving-status-p16.jpg` is Car Status p.14, not a driving viz) | PARTIAL | Low chase down a street: gray buildings, dark asphalt, white lane lines, blue ego lane, traffic with amber lamps, speed and hairline power bar, full-width media player on the viz (title left, art right). Still the CC-BY car, not Tesla’s viz mesh. |
