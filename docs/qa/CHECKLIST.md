...
| --- | --- | --- | --- | --- |
| Parked home | `screenshots/parked-home.png` | `manual-m3-touchscreen-p8.jpg`, `nata-parked-car-vis.jpg` | PARTIAL | Rear three-quarter on a light floor, whole car in frame, light dock, folder All Apps, TRUNK card. Mesh ceiling remains (front well, side glass). |
...
| FSD engaged | `screenshots/fsd-engaged.png` | `nata-ui-v12-hero.jpg`, `nata-intel-spring-update.jpg` (`manual-m3-driving-status-p16.jpg` is Car Status p.14, not a driving viz) | PARTIAL | Unlit gray street: buildings, mid-gray asphalt, white lane lines, blue ego lane, amber lamps, speed and hairline power bar, translucent media player (title left, art right). Nav map is charcoal with the street grid showing. Still the CC-BY car, not Tesla’s viz mesh. |
