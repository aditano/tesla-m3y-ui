...
| --- | --- | --- | --- | --- |
| Parked home | `screenshots/parked-home.png` | `manual-m3-touchscreen-p8.jpg`, `nata-parked-car-vis.jpg`, `nata-status-bar.jpg` | PARTIAL | Higher rear three-quarter, whole car in frame, light dock. Status order: lock, profile, Sentry, cellular, Wi-Fi, time, outdoor temp, “Passenger airbag”. Mesh ceiling remains. |
